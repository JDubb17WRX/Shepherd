...
-- Administrator-managed plain-text overrides for the public Shepherd website.
...
-- Signup Sheets plugin: volunteer / potluck style signup sheets.
CREATE TABLE `signupsheet_shs` (
